...
namespace OpenIdConnectServer.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160816214741_CreateOpenIddictTables")]
    partial class CreateOpenIddictTables
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OpenIdConnectServer.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OpenIdConnectServer.Models.ApplicationUser")
                        .WithMany("Claims")
